...
(function(A, w) {
    ...
    (function() {
        ...
        if (!(!e || !e.length || !j)) {
            c.support = {
                ...
                parentNode: d.removeChild(d.appendChild(s.createElement('div'))).parentNode ===
                    null,
                deleteExpando: true,
                checkClone: false,
                scriptEval: false,
    ...
    (function() {
        ...
        k.filter = function(g, h, l, m) {
            for (
                var q = g, p = [], v = h, t, y, S = h && h[0] && x(h[0]); g && h.length;
    ...
    c.fn.extend({
        find: function(a) {
            for (
                var b = this.pushStack('', 'find', a), d = 0, f = 0, e = this.length; f < e; f++
            ) {
                d = b.length;
                c.find(a, this[f], b);
                if (f > 0)
    ...
    c.extend({
        ...
        dir: function(a, b, d) {
            var f = [];
            for (
                a = a[b]; a && a.nodeType !== 9 && (d === w || a.nodeType !== 1 || !c(a).is(d));
    ...
    c.fn.extend({
        ...
        empty: function() {
            for (var a = 0, b;
                (b = this[a]) != null; a++)
                for (
                    b.nodeType === 1 && c.cleanData(b.getElementsByTagName('*')); b.firstChild;
    ...
    c.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (
                    var a = this.offsetParent || s.body; a &&
