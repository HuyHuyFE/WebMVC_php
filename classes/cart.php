...
class cart
{
	...
	public function add_to_cart($quantity, $id)
	{
		...
		if ($result_check_cart) {
			$msg = "<span class='error'>Phim Đã Được Thêm Vào</span>";
			return $msg;
		} else {
	...
	public function update_quantity_cart($quantity, $cartId)
	{
		...
		if ($result) {
			...
			$msg = "<span class='error'>Không Thành Công</span>";
			return $msg;
		}
	}
	public function del_product_cart($cartid)
	{
		...
		if ($result) {
			...
			$msg = "<span class='error'>Bỏ Chọn Phim Thành Công</span>";
			return $msg;
		}
	}
	...
	// thanh toán thành công: tổng gia
	...
	public function del_shifted($id, $time, $price)
	{
		...
		if ($result) {
			...
			$msg = "<span class='error'>Xóa Thất Bại</span>";
			return $msg;
		}
	}
